...
我一般会用 [see-fetch](https://github.com/liuhaoliang/see-fetch)、[see-ajax](https://github.com/liuhaoliang/see-ajax) 对异步请求进行隔离封装。

注：[see-fetch](https://github.com/liuhaoliang/see-fetch) 是对 `window.fetch` 的封装，[see-ajax](https://github.com/liuhaoliang/see-ajax) 是对 `XMLHttpRequest` 对象的封装。
