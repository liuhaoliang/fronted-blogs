...
之前有写过一篇 [webpack 之外的另一种选择：rollup](https://github.com/liuhaoliang/fronted-blogs/blob/master/advanced/6.md)，这次算是姊妹篇，介绍另外一个工具 [parcel](https://github.com/parcel-bundler/parcel).
