...
[eslint](https://github.com/eslint/eslint) 一般会配合 [husky](https://github.com/typicode/husky) 与 [lint-staged](https://github.com/okonet/lint-staged) 一起使用。详细用法可以参考 [怎样提升代码质量](https://github.com/liuhaoliang/fronted-blogs/blob/master/advanced/3.md)。
...
[stylelint](https://github.com/stylelint/stylelint) 一般会配合 [husky](https://github.com/typicode/husky) 与 [lint-staged](https://github.com/okonet/lint-staged) 一起使用。详细用法可以参考 [怎样提升代码质量](https://github.com/liuhaoliang/fronted-blogs/blob/master/advanced/3.md)。
...
[prettier](https://github.com/prettier/prettier) 一般会配合 [husky](https://github.com/typicode/husky) 与 [lint-staged](https://github.com/okonet/lint-staged) 一起使用。详细用法可以参考 [怎样提升代码质量](https://github.com/liuhaoliang/fronted-blogs/blob/master/advanced/3.md)。
