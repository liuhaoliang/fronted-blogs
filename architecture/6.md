...
独立化组件与私有 npm 仓库配合使用是最完美的，下一节 [私有 npm 仓库](https://github.com/liuhaoliang/fronted-blogs/blob/master/architecture/7.md) 将会讲到。
...
以 [yume](https://github.com/liuhaoliang/yume) 构建工具为例进行说明。
...
解决这个问题当然还是需要构建工具的支持。以 [lila](https://github.com/liuhaoliang/lila) 与 [yume](https://github.com/liuhaoliang/yume) 为例进行说明：
...
上一篇：[构建工具 for teamwork](https://github.com/liuhaoliang/fronted-blogs/blob/master/architecture/5.md)

下一篇：[私有 npm 仓库](https://github.com/liuhaoliang/fronted-blogs/blob/master/architecture/7.md)
