...
独立化组件与私有 npm 仓库配合使用是最完美的，下一节 [私有 npm 仓库](https://github.com/liuhaoliang/blogs/blob/master/architecture/7.md) 将会讲到。
...
上一篇：[构建工具 for teamwork](https://github.com/liuhaoliang/blogs/blob/master/architecture/5.md)

下一篇：[私有 npm 仓库](https://github.com/liuhaoliang/blogs/blob/master/architecture/7.md)
